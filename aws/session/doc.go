...
AWS Services. They are from a configuration file, which must include both
aws_access_key_id and aws_secret_access_key name/value pairs 
for the credentials to be considered valid. 
The values will be ignored if not a complete
